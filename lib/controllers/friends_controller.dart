...
class FriendsController {
  List<Friend> friends = [ // dummyFirneds
    ...
    Friend(id: "kss", name: "김성수", profileImage: ImageAssets.sender, bio: "안녕하세요."),
    Friend(id: "kbj", name: "김병주", profileImage: ImageAssets.sender, bio: "안녕하세요."),
    Friend(id: "jy", name: "장영", profileImage: ImageAssets.sender, bio: "안녕하세요."),
    Friend(id: "pjl", name: "박정록", profileImage: ImageAssets.sender, bio: "안녕하세요."),
